    ...
    <div className="min-h-screen w-full flex bg-black">
      ...
      <div className="hidden lg:flex flex-1 flex-col justify-between p-12 relative overflow-hidden bg-stone-950 border-r border-white/5">
        <div className="absolute inset-0 z-0 pointer-events-none">
          ...
          <div className="absolute bottom-[0%] right-[-10%] w-[50%] h-[50%] rounded-full bg-orange-600/15 blur-[100px]" />
        ...
        <div className="relative z-10 max-w-lg">
          <blockquote className="space-y-4">
            <p className="text-2xl font-medium text-white leading-snug">
              &ldquo;Transforme a forma como você organiza suas vaquejadas. Automatização total do sorteio à final, para quem faz acontecer na arena.&rdquo;
            </p>
            <footer className="text-sm text-stone-400">
              Crie o seu perfil de Organizadora hoje
            </footer>
          </blockquote>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 sm:p-12 overflow-y-auto">
        <div className="w-full max-w-[400px] flex flex-col items-center lg:items-start my-auto">
          ...
          <div className="w-full text-center lg:text-left mb-8">
            <h1 className="text-3xl font-bold text-white mb-2">Seja uma Organizadora</h1>
            <p className="text-stone-400">Crie sua conta e tenha acesso ao painel de gestão premium.</p>
          </div>
          ...
          <p className="mt-8 text-center lg:text-left text-sm text-stone-400 w-full mb-8">
            Já possui uma conta?{' '}
            <Link href="/login" className="text-amber-500 font-medium hover:text-amber-400 hover:underline">
              Fazer Login
            </Link>
          </p>
        </div>
